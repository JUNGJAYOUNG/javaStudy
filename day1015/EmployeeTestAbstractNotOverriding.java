...
/*
EmployeeTestAbstractNotOverriding.java:92: error: HourlyEmployee is not abstract and does not override abstract method computeSalary() in Employee
class HourlyEmployee extends Employee{
^
1 error

//추상클래스를 상속받았다면
반드시 모든 추상메소드를 오버라이딩 해야한다.
